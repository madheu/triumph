...
- Local (preferred, if present):
  `references/official-blueprint-5001.md` (extracted outline)
  and/or `references/StudyCompanion-5001-official.pdf`
- Download sources, in order:
  ...
  `references/StudyCompanion-5001-official.pdf` and the
...
- Official outline (local, when present): `references/official-blueprint-5001.md`
- Official Study Companion PDF (local, when present): `references/StudyCompanion-5001-official.pdf`
- Triumph question template: `references/question-schema.json`
- Market research notes are project-local; outline extraction is self-contained in references/
