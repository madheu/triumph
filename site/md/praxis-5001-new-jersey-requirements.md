...
ETS lists the individual subtests as an option for New Jersey candidates, so subtest-by-subtest registration is available. Confirm with the New Jersey Department of Education that your program and application path allow it.[1]

### Do New Jersey Praxis scores expire?
...
[1] ETS, "New Jersey Required Tests." [https://praxis.ets.org/state-requirements/newjersey-tests.html](https://praxis.ets.org/state-requirements/newjersey-tests.html)
