...
| Subtest | Name | Focus | Bank size |
| --- | --- | --- | --- |
| 5002 | Reading & Language Arts | Phonics, vocabulary, comprehension, writing instruction. | 214 questions |
| 5003 | Mathematics | Number sense, algebra, geometry, data — and how to teach it. | 172 questions |
| 5004 | Social Studies | US history & government, geography, world history, economics. | 240 questions |
| 5005 | Science | Earth, life & physical science — plus inquiry and pedagogy. | 343 questions |

## Why this exam breaks people

It's not one test. It's four gates, *in sequence.*

Every subtest has its own passing score. Score high on math and fail science — **you don't pass, you retake science** (full price, 28 days later). Most candidates discover the weak one only after the score report arrives.

This is not a niche fear. A **majority of first-time elementary teacher candidates fail** the most widely used licensure exam, and its first-time pass rate sits **below the bar exam**. Some candidates sit for it eleven times.

- **>50%** — of first-time elementary candidates fail the licensure exam (NCTQ)
- **4/4** — subtests must pass; one failing gate means a full retake
- **11×** — attempts by one candidate on the teacher forums (real post)
