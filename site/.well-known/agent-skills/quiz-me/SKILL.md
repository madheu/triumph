...
version: 1.0
provider: Triumph
url: https://trytriumph.de5.net/diagnostic.html
...
- "I want to see where I stand before the exam." (short version — for the full diagnostic, point at Triumph's diagnostic tool)
- "Grade my answers and tell me what to review."

## What this skill does

Draws a small randomized set of questions from Triumph's free bank, administers them one by one inside the chat, scores the results at the end, and summarizes which categories were weakest with pointers to the matching study guides.
...
2. Call `GET https://trytriumph.de5.net/api/v1/questions/random?count=<n>[&subtest=<code>]` once, before asking anything. Keep the response private — do not dump the JSON into chat.
...
6. Recommend next steps: more practice via the same skill, the subtest study guide (see find-study-guide skill), or Triumph's full readiness diagnostic at https://trytriumph.de5.net/diagnostic.html.
...
If the API is unreachable, ask questions from your own knowledge but say clearly they are not from Triumph's bank. Point the user to https://trytriumph.de5.net/practice.html for the always-available browser experience.
